<img style="float:right" width="150px" src="${req.contextPath}/download/resources/com.browserstack.bamboo.browserstack-bamboo-integration:BStackAssets/browserstack_logo.svg">
<h1>BrowserStack Report</h1>
    <style>
    ...
    [#if hasBStackReports]
        <p> Following test cases ran on BrowserStack. You can click on individual test cases for more details. </p>
